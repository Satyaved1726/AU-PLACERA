-- Migration 08: Fix create_admin_user RPC function to prevent profiles duplicate key violations
...
BEGIN
  ...
  -- 5. Insert Auth credentials (will automatically trigger handle_new_user())
